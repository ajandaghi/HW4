...
public class TicketRepository {
    ...
    public void orderTicket(Tickets tickets ) throws SQLException {
String sql="insert into ticket (ticketId,holder_user) values (?,?)";
    ...
    public Tickets[] findTicketByUser(String user) throws SQLException {
        ...
        while(resultSet.next()){
            if(i==0) {resultNum.next(); ticket=new Tickets[resultNum.getInt(1)];}
